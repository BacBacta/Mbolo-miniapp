...
| Profil | Prénom, âge 18+, genre, intention (amitié, relation sérieuse), pays, ville libre, quartier, question, langues, deux questions de compatibilité facultatives en « Relation sérieuse » (mariage, enfants), jusqu'à six photos facultatives (deux sans pass, la borne s'applique à l'envoi et jamais à l'affichage), chacune modérée, compressées côté client |

...
- La mesure produit **ne dit rien rétroactivement** : tous les chiffres partent du jour où les lignes sont posées. Les horodatages d'entonnoir existent, les événements (lot M3) et la lecture (lot M4) pas encore. Voir `audit/05-mesure-produit.md`.

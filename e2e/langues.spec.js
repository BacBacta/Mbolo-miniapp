...
// qu'elle manque à la liste que l'écran parcourt, ou que son dictionnaire ne se charge pas.
...
test('les sept langues sont proposées, et le choix change vraiment l’interface', async ({ page }) => {
  ...
  // sienne sans lire le français.
  await expect(page.locator('.list .list-row .title')).toHaveText([
    'Français', 'English', 'Español', 'Português', 'Kiswahili', 'Русский', 'Українська',
  ]);

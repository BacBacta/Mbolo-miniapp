...
const EN = {
  ...
  "{nom} t'a envoyé une photo.": '{nom} sent you a photo.',
  'Répondre': 'Reply',
...
const ES = {
  ...
  "{nom} t'a envoyé une photo.": "{nom} te ha enviado una foto.",
  "Répondre": "Responder",
...
const PT = {
  ...
  "{nom} t'a envoyé une photo.": "{nom} enviou-te uma foto.",
  "Répondre": "Responder",
...
const SW = {
  ...
  "{nom} t'a envoyé une photo.": "{nom} amekutumia picha.",
  "Répondre": "Jibu",
...
const RU = {
  ...
  "{nom} t'a envoyé une photo.": '{nom} отправил(а) тебе фото.',
  'Répondre': 'Ответить',
...
const UK = {
  ...
  "{nom} t'a envoyé une photo.": '{nom} надіслав(ла) тобі фото.',
  'Répondre': 'Відповісти',

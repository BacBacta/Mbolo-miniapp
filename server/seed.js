...
export const DEMO = [
  ...
  { id: 'demo-carine', firstName: 'Carine', age: 24, gender: 'femme', intent: 'serieux', country: 'CM', city: 'Yaoundé', area: 'Bastos', promptQ: 'plat', promptA: 'Le ndolé plantain de ma tante', languages: 'Français, ewondo', photos: 3, trust: { selfie: true, guarantor: true, seniority: true } },
  ...
  { id: 'demo-thierry', firstName: 'Thierry', age: 26, gender: 'homme', intent: 'serieux', country: 'CM', city: 'Yaoundé', area: 'Efoulan', promptQ: 'plat', promptA: 'Le koki, avec beaucoup de piment', languages: 'Français, bamiléké', photos: 1, trust: { selfie: true, guarantor: true, seniority: false } },
  ...
  { id: 'demo-aicha', firstName: 'Aïcha', age: 26, gender: 'femme', intent: 'amitie', country: 'CM', city: 'Yaoundé', area: 'Bastos', promptQ: 'plat', promptA: 'Le riz sauce arachide de ma mère', languages: 'Français, fulfulde', photos: 3, trust: { selfie: true, guarantor: true, seniority: true } },
  ...
  { id: 'demo-mireille', firstName: 'Mireille', age: 25, gender: 'femme', intent: 'duo', country: 'CM', city: 'Yaoundé', area: 'Biyem-Assi', promptQ: 'weekend', promptA: 'Un karaoké à quatre, avec ma meilleure amie', languages: 'Français', photos: 1, trust: { selfie: true, guarantor: true, seniority: true } },
  { id: 'demo-stephane', firstName: 'Stéphane', age: 26, gender: 'homme', intent: 'duo', country: 'CM', city: 'Yaoundé', area: 'Omnisport', promptQ: 'coin', promptA: 'Le parc de la Mefou, puis un poulet DG avec mon pote', languages: 'Français, anglais', photos: 1, trust: { selfie: true, guarantor: false, seniority: true } },
  { id: 'demo-patricia', firstName: 'Patricia', age: 23, gender: 'femme', intent: 'duo', country: 'CM', city: 'Yaoundé', area: 'Nsimeyong', promptQ: 'weekend', promptA: 'Les soirées jeux de société, avec ma sœur', languages: 'Français, anglais', photos: 2, trust: { selfie: true, guarantor: false, seniority: false } },
  ...
  { id: 'demo-chantal', firstName: 'Chantal', age: 24, gender: 'femme', intent: 'serieux', country: 'CM', city: 'Douala', area: 'Akwa', promptQ: 'plat', promptA: 'Le poisson braisé de la rue de la Joie', languages: 'Français, anglais', photos: 2, trust: { selfie: true, guarantor: true, seniority: true } },

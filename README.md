...
Prototype déployable d'une mini app de rencontres, ouverte à tous les pays et pensée d'abord pour l'Afrique francophone : profils vérifiés par selfie, demandes d'argent bloquées, rendez-vous dans des lieux publics partenaires avec confirmation d'arrivée par QR code, mode économie de data (les vignettes des listes, jamais la photo de la fiche qu'on décide).
...
5. **Temps réel** (WebSocket ou SSE) à la place de l'interrogation, dont la cadence suit aujourd'hui l'activité du fil (1,5 s / 4 s / 10 s), quand le trafic le justifie.

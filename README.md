...
Ce que le pass donnera encore (l'ordre du paquet au choix) n'est **pas construit**, et l'écran du pass ne l'annonce donc pas : une promesse affichée que rien n'honore est pire qu'une fonction absente, parce que la personne l'a crue — la leçon de « Sortie en duo ».
